object FrmSimpleEditor: TFrmSimpleEditor
  ...
  object PnlRichEdt: TPanel
    ...
    object RichEdtSimple: TRichEdit
      ...
      ScrollBars = ssBoth
      TabOrder = 0
      OnKeyDown = RichEdtSimpleKeyDown
  ...
  object PnlToolBarMain: TPanel
    ...
    object PnlToolBarCbBox: TPanel
      ...
      object CbBoxFontName: TComboBox
        ...
        TabOrder = 0
        OnChange = CbBoxFontNameChange
        OnDrawItem = CbBoxFontNameDrawItem
        OnMeasureItem = CbBoxFontNameMeasureItem
      end
      object CbBoxFontSize: TComboBox
        Left = 163
        Top = 3
        Width = 51
        Height = 21
        Hint = #1088#1072#1079#1084#1077#1088' '#1096#1088#1080#1092#1090#1072
        ItemIndex = 4
        TabOrder = 1
        Text = '10'
        OnKeyPress = CbBoxFontSizeKeyPress
        OnSelect = CbBoxFontSizeSelect
        Items.Strings = (
          '6'
          '7'
          '8'
  ...
  object ActManager: TActionManager
        ...
        Items = <
          item
            Items = <
              ...
              item
                Action = ActCloseFileWithSave
                ImageIndex = 4
                ShortCut = 16467
              end
              item
                Action = ActCloseFileWithOutSave
                ImageIndex = 5
                ShortCut = 16465
              end>
    ...
    object ActPgStp: TFilePageSetup
      Category = #1060#1072#1081#1083
    ...
    object ActCutToClipbrd: TEditCut
    ...
    object ActCopyToClipbrd: TEditCopy
      Category = #1055#1088#1072#1074#1082#1072
    ...
    object ActPasteToClipbrd: TEditPaste
      Category = #1055#1088#1072#1074#1082#1072
    ...
    object RichEditBold1: TRichEditBold
      ...
      ImageIndex = 20
      ShortCut = 16450
      OnExecute = RichEditBold1Execute
    end
    object RichEditItalic1: TRichEditItalic
      ...
      ImageIndex = 21
      ShortCut = 16457
      OnExecute = RichEditItalic1Execute
    end
    object RichEditUnderline1: TRichEditUnderline
      ...
      ImageIndex = 23
      ShortCut = 16469
      OnExecute = RichEditUnderline1Execute
    end
    object RichEditStrikeOut1: TRichEditStrikeOut
      ...
      ImageIndex = 22
      ShortCut = 16473
      OnExecute = RichEditStrikeOut1Execute
    end
    ...
    object RichEditAlignLeft1: TRichEditAlignLeft
      ...
      Checked = True
      Hint = #1042#1099#1088#1072#1074#1085#1080#1074#1072#1085#1080#1077' '#1090#1077#1082#1089#1090#1072' '#1089#1083#1077#1074#1072
      ImageIndex = 16
      OnExecute = RichEditAlignLeft1Execute
    end
    object RichEditAlignCenter1: TRichEditAlignCenter
      ...
      ImageIndex = 17
      OnExecute = RichEditAlignCenter1Execute
    end
    object RichEditAlignRight1: TRichEditAlignRight
      ...
      Hint = #1042#1099#1088#1072#1074#1085#1080#1074#1072#1085#1080#1077' '#1090#1077#1082#1089#1090#1072' '#1089#1087#1088#1072#1074#1072
      ImageIndex = 18
      OnExecute = RichEditAlignRight1Execute
    end
    ...
    object ActCloseFileWithSave: TAction
      Category = #1060#1072#1081#1083
      ...
      ImageIndex = 4
      ShortCut = 16467
      OnExecute = ActCloseFileWithSaveExecute
    end
    object ActCloseFileWithOutSave: TAction
      Category = #1060#1072#1081#1083
      ...
      ImageIndex = 5
      ShortCut = 16465
      OnExecute = ActCloseFileWithOutSaveExecute
    end
    ...
    object ActFontSizeInc: TAction
      ...
      Hint = #1059#1074#1077#1083#1080#1095#1080#1090#1100' '#1074#1099#1076#1077#1083#1077#1085#1085#1099#1081' '#1096#1088#1080#1092#1090
      ImageIndex = 34
    ...
    object ActFontSizeDec: TAction
      ...
      Hint = #1059#1084#1077#1085#1100#1096#1080#1090#1100' '#1074#1099#1076#1077#1083#1077#1085#1085#1099#1081' '#1096#1088#1080#1092#1090
      ImageIndex = 33
      OnExecute = ActFontSizeDecExecute
    end
    object ActCapit: TAction
      Category = #1064#1088#1080#1092#1090
      Caption = #1042#1089#1077' '#1087#1088#1086#1087#1080#1089#1085#1099#1077
      Hint = #1042#1089#1077' '#1073#1091#1082#1074#1099' '#1074' '#1074#1099#1076#1077#1083#1077#1085#1085#1086#1084' '#1092#1088#1072#1075#1084#1077#1085#1090#1077' '#1055#1056#1054#1055#1048#1057#1053#1067#1045
      ImageIndex = 36
      OnExecute = ActCapitExecute
    end
    object ActDecapit: TAction
      Category = #1064#1088#1080#1092#1090
